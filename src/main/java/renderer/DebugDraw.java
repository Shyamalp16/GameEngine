...
public class DebugDraw {
    ...
    private static Shader shader = AssetPool.getShader("D:\\GameEngine\\assets\\shaders\\debugLine2D.glsl");
...
//    ----------------------------------- ADD CIRCLE -------------------------------------------------------------------
    public static void addBox2D(Vector2f center, float radius){
        addCircle2D(center, radius, new Vector3f(0,1,0), 1);
    }

    public static void addBox2D(Vector2f center, float radius, Vector3f color){
