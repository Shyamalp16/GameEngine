...
import engine.SceneHeirarchyWindow;
import imgui.*;
...
public class ImGuiLayer {
    ...
    private final ImGuiImplGlfw imGguiGlfw = new ImGuiImplGlfw();
    ...
    public void initImGui() {
        ...
        io.setIniFilename("imgui.ini"); // Save window config
...
//
        ...
        imGguiGlfw.init(glfwWindow, false);
